...
class QAgent(Agent):
    ...
    def __init__(self, n_states, n_actions,
        ...
        self.epsilon = 0.7  # epsilon (p-wo akcji losowej)
    ...
    def init_q_table(self, initial_q_value=0.):
        ...
        q_table = np.full((self.n_states, self.n_actions), initial_q_value, dtype=float)
        return q_table
    ...
    def choose_action(self, state: State) -> Action:
        ...
        # drawing float to decide if next action should be random
