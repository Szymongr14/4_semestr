...
class AlphaBetaAgent(MinMaxAgent):
    ...
    def decide(self, connect4) -> int:
        self.alpha_beta(connect4, self.max_tree_depth, True, float('-inf'), float('+inf'))
        return self.best_move

    def alpha_beta(self, connect4, depth, maximizing_player, alpha, beta):
        ...
        if maximizing_player:
            ...
            for possible_move in connect4.possible_drops():
                ...
                value = self.alpha_beta(connect4, depth - 1, False, alpha, beta)
            ...
            for possible_move in connect4.possible_drops():
                connect4.drop_token(possible_move, True)
                value = self.alpha_beta(connect4, depth - 1, True, alpha, beta)
                connect4.undo_last_move()
